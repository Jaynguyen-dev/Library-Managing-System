...
router.post("/", authMiddleware, roleGuard("admin", "librarian"), bookController.create);
router.put("/:id", authMiddleware, roleGuard("admin", "librarian"), bookController.update);
